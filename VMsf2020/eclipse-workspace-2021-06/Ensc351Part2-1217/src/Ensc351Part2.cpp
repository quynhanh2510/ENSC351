...
//      testSenderY(iFileNamesA, daSktPrMT2[TermSkt]);
...
int Ensc351Part2()
{
    ...
    posixThread term2Thrd(SCHED_FIFO, 70, termFunc, Term2);  //Sender
    ...
    posixThread mediumThrd(SCHED_FIFO, 40, mediumFunc, daSktPrT1M[MediumSkt],daSktPrMT2[MediumSkt], "ymodemData.dat"); //kindMedium

    termFunc(Term1); //Receiver          //should have term1Thrd???

    term2Thrd.join(); // join with thread for Term2
