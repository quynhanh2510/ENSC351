...
#define ST_FIRSTBYTESTAT         1
#define ST_CONDLTRANSIENTSTAT    2
#define ST_CONDTRANSIENTCHECK    3
#define ST_CONDTRANSIENTOPEN     4
#define ST_FIRSTBYTEDATA         5
#define ST_CONDTRANSIENTDATA     6
#define ST_EOT                   7
#define ST_CONDTRANSIENTEOT      8
#define ST_CAN                   9
