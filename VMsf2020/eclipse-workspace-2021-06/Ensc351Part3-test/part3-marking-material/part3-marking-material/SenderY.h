...
#define ST_WAIT_C_1         1
#define ST_CHECKFILES       2
#define ST_WAIT_ACKNAK_1    3
#define ST_WAIT_C_2         4
#define ST_CHECKDATA        5
#define ST_WAIT_ACKNAK_2    6
#define ST_WAIT_NAK         7
#define ST_WAIT_ACK         8
#define ST_WAIT_ACKNAK_3    9
#define ST_WAIT_CAN         10

/*#define ST_WAIT_C_1         1
#define ST_WAIT_ACKNAK_1    2
#define ST_WAIT_C_2         3
#define ST_WAIT_ACKNAK_2    4
#define ST_MOREBLKS         5
#define ST_WAIT_NAK         6
#define ST_WAIT_ACK         7
#define ST_MOREFILES        8
#define ST_WAIT_C_3         9
#define ST_WAIT_ACKNAK_3    10
#define ST_WAIT_CAN         11*/
...
//  ;
	...
	int fileNameIndex;
	int EOTcounter;
	uint8_t backupBlkBuf[BLK_SZ_CRC];
};
